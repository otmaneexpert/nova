...
//             Réservez votre inspection maintenant
//           </h2>
//           <p className="mt-4 opacity-90 max-w-2xl mx-auto">
//             Remplissez ce formulaire et notre équipe vous contactera rapidement pour confirmer votre demande et planifier l'inspection à l'endroit qui vous convient.
//           </p>
//         </div>
...
//                 className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:border-secondary"
//                 value={formData.name}
...
//                 rows={4}
//                 className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:border-secondary resize-none"
...
//               <button
//                 type="submit"
//                 className="mt-6 w-full bg-secondary hover:bg-secondary/90 text-white font-semibold py-3 px-8 rounded-full transition-colors"
//               >
//                 Envoyer ma demande
//               </button>
//             </div>
